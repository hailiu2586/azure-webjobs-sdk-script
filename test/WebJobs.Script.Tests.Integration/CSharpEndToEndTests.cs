...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class CSharpEndToEndTests : EndToEndTestsBase<CSharpEndToEndTests.TestFixture>
    {
        ...
        public async Task Proxy_Http_Request()
        {
            ...
            var originalRequest = actualRequestObject.Serialize();
            ...
            expectedRequestObject.Deserialize(content);
        ...
        public async Task Proxy_Http_Response()
        {
            ...
            actualResponseObject.Deserialize(originalResponse);
            ...
            expectedResponseObject.Deserialize(content);
